...
public class LaunchActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        dishRepository.insert(new Dish(200,
                "Foods",
                "зелень цветочная с горошком",
                999,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(300,
                "Foods",
                "картофель",
                100,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(400,
                "Foods",
                "картошечка домашняя",
                799,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(500,
                "Foods",
                "деревенский картофель",
                10,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(600,
                "Drinks",
                "Кола",
                9,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(700,
                "Drinks",
                "компот",
                8,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(800,
                "Drinks",
                "lemonad",
                8,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(900,
                "Snacks",
                "чипсы",
                15,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(99,
                "Snacks",
                "Нагетсы",
                12,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(89,
                "Sauce",
                "Барбекю",
                7,
                "zalupa.jpg",
                "1.3"));
        dishRepository.insert(new Dish(79,
                "Sauce",
                "Сырный",
                6,
                "zalupa.jpg",
